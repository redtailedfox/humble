...
func (p *EchoClient) Call(ctx context.Context, req *Request) (r *Response, err error) {
	var _args EchoCallArgs
	_args.Req = req
	var _result EchoCallResult
...
func NewEchoProcessor(handler Echo) *EchoProcessor {
	...
	self.AddToProcessorMap("call", &echoProcessorCall{handler: handler})
	return self
}
...
type echoProcessorCall struct {
	handler Echo
}

func (p *echoProcessorCall) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := EchoCallArgs{}
...
type EchoCallArgs struct {
	Req *Request `thrift:"req,1" frugal:"1,default,Request" json:"req"`
}

func NewEchoCallArgs() *EchoCallArgs {
	return &EchoCallArgs{}
}

func (p *EchoCallArgs) InitDefault() {
	*p = EchoCallArgs{}
}

var EchoCallArgs_Req_DEFAULT *Request

func (p *EchoCallArgs) GetReq() (v *Request) {
	if !p.IsSetReq() {
		return EchoCallArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *EchoCallArgs) SetReq(val *Request) {
	p.Req = val
}

var fieldIDToName_EchoCallArgs = map[int16]string{
	1: "req",
}

func (p *EchoCallArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *EchoCallArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoCallArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoCallArgs) ReadField1(iprot thrift.TProtocol) error {
	p.Req = NewRequest()
...
func (p *EchoCallArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *EchoCallArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *EchoCallArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoCallArgs(%+v)", *p)
}

func (p *EchoCallArgs) DeepEqual(ano *EchoCallArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EchoCallArgs) Field1DeepEqual(src *Request) bool {
...
func NewEchoCallResult() *EchoCallResult {
	return &EchoCallResult{}
}

func (p *EchoCallResult) InitDefault() {
	*p = EchoCallResult{}
}

var EchoCallResult_Success_DEFAULT *Response

func (p *EchoCallResult) GetSuccess() (v *Response) {
	if !p.IsSetSuccess() {
		return EchoCallResult_Success_DEFAULT
	}
	return p.Success
}
func (p *EchoCallResult) SetSuccess(x interface{}) {
	p.Success = x.(*Response)
}

var fieldIDToName_EchoCallResult = map[int16]string{
	0: "success",
}

func (p *EchoCallResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *EchoCallResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_EchoCallResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *EchoCallResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *EchoCallResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *EchoCallResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
...
func (p *EchoCallResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoCallResult(%+v)", *p)
}

func (p *EchoCallResult) DeepEqual(ano *EchoCallResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *EchoCallResult) Field0DeepEqual(src *Response) bool {
